	...
	return {
		...
		<div class="radio-inline"> <label class="demo--label"> <input type="radio" class="demo--radio" name="optionsRadios{{$index}}" id="optionsRadios1" value="option1" ng-click="xuan1()" ng-checked="true"> <div class=" demo--radioInput"></div>填空 </label> </div>\
		<div class="radio-inline"> <label class="demo--label"> <input type="radio" class="demo--radio" name="optionsRadios{{$index}}" id="optionsRadios2" value="option2" ng-click="xuan2()"> <div class=" demo--radioInput"></div> 单选</label> </div>\
		<div class="radio-inline"> <label class="demo--label"> <input type="radio" class="demo--radio" name="optionsRadios{{$index}}" id="optionsRadios3" value="option3" ng-click="xuan3()"> <div class=" demo--radioInput"></div> 多选 </label> </div>\
		<div class="radio-inline"> <label class="demo--label"> <input type="radio" class="demo--radio" name="optionsRadios{{$index}}" id="optionsRadios4" value="option4" ng-click="xuan4()"> <div class=" demo--radioInput"></div> 简答</label> </div>\
		</div>\
